...
var metrics = [ 'waste', 'economy', 'happiness', 'democracy', 'temp' ];
...
var blocks = [
    ...
    { name: "Use re-usable water bottle and lunchbox", type: "Individual Action", categories: { heating: 3, waste: 4, economy: 4, happiness: 1, democracy: 0 } },
    { name: "Shop at plastic-free shop", type: "Individual Action", categories: { heating: 3, waste: 4, economy: 3, happiness: 2, democracy: 0 } },
    { name: "Run a campaign at school", type: "Individual Action", categories: { heating: 4, waste: 4, economy: 2, happiness: 2, democracy: 4 } },
    { name: "Talk to your MP/Councillor", type: "Individual Action", categories: { heating: 4, waste: 3, economy: 2, happiness: 2, democracy: 5 } },
    { name: "Go on a Youth Strike", type: "Individual Action", categories: { heating: 5, waste: 3, economy: 2, happiness: 3, democracy: 5 } },
    ...
    { name: "Supermarkets ban single-use plastics", type: "Policy", categories: { heating: 4, waste: 4, economy: 4, happiness: 2, democracy: 3 } },
    ...
    { name: "Living wage for UK; ensure people can afford more ethical clothes", type: "Policy", categories: { heating: 5, waste: 5, economy: 5, happiness: 5, democracy: 5 } },
    { name: "Reduce Food waste and compost/ anaerobic digest food that can't be eaten.", type: "Policy", categories: { heating: 5, waste: 5, economy: 5, happiness: 4, democracy: 2 } },
    { name: "4 day working week; buy less, make less, live more", type: "Policy", categories: { heating: 5, waste: 5, economy: 3, happiness: 5, democracy: 5 } },
    { name: "Remove subsidies for fossil fuels, and bring in subsidies for renewables", type: "Policy", categories: { heating: 5, waste: 5, economy: 3, happiness: 5, democracy: 5 } },
    { name: "Insulate all homes and buildings to a high standard", type: "Policy", categories: { heating: 5, waste: 3, economy: 3, happiness: 4, democracy: 2 } },
    ...
    { name: "Repair Café", type: "Places and facilities", categories: { heating: 4, waste: 4, economy: 4, happiness: 4, democracy: 3 } },
    { name: "Clothes Swaps", type: "Places and facilities", categories: { heating: 4, waste: 4, economy: 4, happiness: 4, democracy: 2 } },
    ...
    { name: "Leeds Hackspace", type: "Places and facilities", categories: { heating: 4, waste: 4, economy: 4, happiness: 4, democracy: 2 } },
    ...
    { name: "Fast Fashion factory", type: "Places and facilities", categories: { heating: -4, waste: -5, economy: -5, happiness: -3, democracy: -3 } },
    { name: "SCRAP Re-use", type: "Places and facilities", categories: { heating: 3, waste: 4, economy: 4, happiness: 2, democracy: 0 } },
    { name: "Seagulls", type: "Places and facilities", categories: { heating: 3, waste: 4, economy: 4, happiness: 2, democracy: 0 } },
    ...
    { name: "Incinerator", type: "Places and facilities", categories: { heating: -5, waste: -5, economy: -5, happiness: -3, democracy: 0 } },

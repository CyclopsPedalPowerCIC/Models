...
var espurl = "http://192.168.4.1";
//may need to enable The Same Origin Policy disallows reading the remote resource at in firefox

var timer;
var timelimit = 3000; //time after which to give up on on esp reponse and try again
var lasttimer=0;
...
/* mask code... from calorie counter
...
function animationLoop() {
	...
	changeBars(numsens,chartpos,values,1023)
...
function bars1(in1, in2){
	//any function here will run when created
	this.test=in1;
	this.tfunc=function(){console.log(in2);}
	
}

var dtd=new bars1("Hi1","Hi3");
console.log(dtd.test);
dtd.tfunc();

...
int checkSockets(){
   ...
   for (int i=0;i<NUM_SOCKETS;i++){socketstate[i]=0;socketaddress[0][i]=0;socketaddress[1][i]=0;}//to keep track of whther they are still there
   int sNum=0;
...
devicesocket[sNum]=-1;  //set socket as unknown
  //do some more stuff?
  }

...
long start = millis();
int mode[totalPins]={0,0,0,1,2,3,1}; //0 = timed or basic (if t=0) 1= toggle 2=off, 3=on
...
void setup() { 
    for (int i=0;i<totalPins;i++)
  {
   ...
   dataLink.addFunc('?','M',&setMode);  //set Mode  as aIDMD?MPM   where P is pin and M is mode
